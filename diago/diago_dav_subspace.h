...
class Diago_DavSubspace : public DiagH<T, Device>
{
  ...
  public:
    ...
    // Diago_DavSubspace(const Diago_DavSubspace& other): 
    //   diag_comm(other.diag_comm), diag_thr(other.diag_thr), iter_nmax(other.iter_nmax), is_subspace(other.is_subspace),
    //   n_band(other.n_band), dim(other.dim), nbase_x(other.nbase_x), precondition(other.precondition)
    // {
    //   std::cout << "Copy constructor called" << std::endl;
    // }

    // Diago_DavSubspace(Diago_DavSubspace&& other): 
    //   diag_comm(other.diag_comm), diag_thr(other.diag_thr), iter_nmax(other.iter_nmax), is_subspace(other.is_subspace),
    //   n_band(other.n_band), dim(other.dim), nbase_x(other.nbase_x), precondition(other.precondition) 
    // {
